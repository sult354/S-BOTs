/*
RAFLI FERNAZER PENGEMBANG SC GAK JELAS 
SUBSCRIBE Rafli Fernazer
GUE BACK NGEBOT UDH 3 BULAN LEBIH GK MAIN BOT
SILAHKAN DI PAKE JIKA SUKA SMA SC INI
*/
...
fake = `™ Rafli Fernazer ™` 
footerr = `© Rafli Fernazer ©` 
bio = `Rafli Teams ID (1)`
yt = `Rafli Fernazer`
banChats = true
...
//=========== Button ===========//                        
        ...
        const ftroli = { 
            key: { fromMe: false,"participant":"0@s.whatsapp.net",   "remoteJid": "6289523258649-1604595598@g.us"  }, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: fakeimage, surface: 200, message: fake, orderTitle: '™ Rafli Fernazer ™', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}                                                                        
        const fakecell = (teks) => { 
...
//------------------< Premium >-------------------
       ...
       case 'buypremium':
       case 'sewabot':
              gopeynya = 'https://i.ibb.co/5TrfL2n/gambar.jpg'
              teksnya = `*── 「 PRICE LIST 」 ──*
...
client.sendMessage(from, Rafliyah, MessageType.audio, {quoted: ftroli, mimetype: 'audio/mp4', ptt:true})
      ...
      case 'sc':
      case 'sourcecode':
              textImg(`https://youtube.com/Fernazer`)
...
Rafliyah3 = fs.readFileSync('./badlogic/?rafli3.mp3');
client.sendMessage(from, Rafliyah3, MessageType.audio, {quoted: ftroli, mimetype: 'audio/mp4', ptt:true})
              break
      case 'ping':
      case 'speed':
              timestampe = speed();
